...
class TestParentNode(unittest.TestCase):
    ...
    def test_recursive_to_html_nested_parents(self):
        ...
        to_html = node.to_html()
        self.assertEqual(to_html, "<p><b>Bold text</b>Normal text<code><i>italic text</i>Normal text</code></p>") 
    ...
    def test_recursive_html_deep_nesting(self):
        ...
        to_html = node.to_html()
        self.assertEqual(to_html, "<b><b>Bold text</b>Normal text<code><i>italic text</i><blockquote><title>test title</title><body><link>www.test.com</link><head>this is a heading</head></body></blockquote></code></b>")
