...
class TestSplitDelimiter(unittest.TestCase):
    ...
    def test_split_delimiter_multiple_nodes(self):
        node_list = [TextNode("This is some TEXT and then **bold** text", TextType.TEXT), TextNode("**Bold** to start followed by TEXT text", TextType.TEXT)]
...
class TestMarkdownLinkImageExtraction(unittest.TestCase):
    ...
    def test_split_nodes_image(self):
        node = TextNode("This is text with an ![image](https://www.image.com) that we are testing", TextType.TEXT)
    ...
    def test_multiple_split_nodes_image(self):
        node = TextNode("This is text with an ![image](https://www.image.com) that we are testing and ![here](https://www.another.com) is another and a [link](https://www.link.com)", TextType.TEXT)
        split_images = split_nodes_image([node])
        self.assertListEqual(
            [
                TextNode("This is text with an ", TextType.TEXT),
                ...
                TextNode(" is another and a [link](https://www.link.com)", TextType.TEXT)
            ],
            split_images,
        )

    def test_split_nodes_link(self):
        node = TextNode("This is text with an [link](https://www.link.com) that we are testing", TextType.TEXT)
    ...
    def test_multiple_split_nodes_image(self):
        ...
        self.assertListEqual(
            [
                ...
                TextNode(" is another and a ![image](https://www.image.com)", TextType.TEXT)
            ],
            split_links,
        )
...
class TestTextToTextNodes(unittest.TestCase):
    ...
    def test_text_to_text_nodes_missing_urls(self):
        ...
        self.assertListEqual(
            [
                TextNode("[link with no url]", TextType.TEXT)
            ],
            text_nodes
        )
        ...
        self.assertListEqual(
            [
                TextNode("![image with no url]", TextType.TEXT)
            ],
            text_nodes
        )
